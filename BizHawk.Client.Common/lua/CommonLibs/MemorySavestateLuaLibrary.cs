...
namespace BizHawk.Client.Common
{
	public sealed class MemorySavestateLuaLibrary : DelegatingLuaLibrary
	{
		...
		public string SaveCoreStateToMemory() => APIs.MemorySaveState.SaveCoreStateToMemory().ToString();
		...
		public void LoadCoreStateFromMemory(string identifier) => APIs.MemorySaveState.LoadCoreStateFromMemory(new Guid(identifier));
		...
		public void DeleteState(string identifier) => APIs.MemorySaveState.DeleteState(new Guid(identifier));
