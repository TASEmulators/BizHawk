...
namespace BizHawk.Client.Common
{
	...
	public sealed class EmulationLuaLibrary : DelegatingLuaLibrary
	{
		...
		public void DisplayVsync(bool enabled) => APIs.Emulation.IsVSyncEnabled = enabled;
		...
		public LuaTable GetRegisters() => APIs.Emulation.GetRegisters().ToLuaTable(Lua);
		...
		public string GetSystemId() => APIs.Emulation.SystemID;
		...
		public void SetIsLagged(bool value = true) => APIs.Emulation.IsLagged = value;
		...
		public void SetLagCount(int count) => APIs.Emulation.LagCount = count;
		...
		public string GetDisplayType() => APIs.Emulation.DisplayType;
		...
		public string GetBoardName() => APIs.Emulation.BoardName;
