...
structs.polyobj = utils.struct_layout("polyobj")
	...
	.prop ("segs", function (self)
		return structs.seg.pointer_array(self.segs_ptr, "System Bus", self.numsegs)
	end)
	.build()
...
structs.globals = utils.global_layout()
	...
	.prop ("mobjs", function(self)
		return structs.mobj.pointer_array(symbols.mobj_ptrs, "System Bus", self.thinker_count)
	end)
	.prop ("lines", function(self)
		return structs.line.array(self.lines_ptr, "System Bus", self.numlines)
	end)
	.prop ("sectors", function(self)
		return structs.sector.array(self.sectors_ptr, "System Bus", self.numsectors)
	end)
	.prop ("polyobjs", function(self)
		return structs.polyobj.array(self.polyobjs_ptr, "System Bus", self.po_NumPolyobjs)
	end)
	.prop ("TaggedLines", function(self)
		return structs.taggedline.array(assert(symbols.TaggedLines), "System Bus", self.TaggedLineCount)
	end)
