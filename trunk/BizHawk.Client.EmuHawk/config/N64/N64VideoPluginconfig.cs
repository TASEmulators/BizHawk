...
namespace BizHawk.Client.EmuHawk
{
	public partial class N64VideoPluginconfig : Form
	{
		...
		private void SaveSettings()
		{
			...
			ss.GlidePlugin.AutodetectUCode = Glide_autodetect_ucode.Checked;
			ss.GlidePlugin.UCode = Glide_ucode.SelectedIndex;
			ss.GlidePlugin.FlameCorona = Glide_flame_corona.Checked;
			ss.GlidePlugin.CardId = Glide_card_id.SelectedIndex;
			ss.GlidePlugin.TexFilter = Glide_tex_filter.SelectedIndex;
			ss.GlidePlugin.WireFrame = Glide_wireframe.Checked;
			ss.GlidePlugin.WFMode = Glide_wfmode.SelectedIndex;
			ss.GlidePlugin.FastCRC = Glide_fast_crc.Checked;
			ss.GlidePlugin.FilterCache = Glide_filter_cache.Checked;
			ss.GlidePlugin.UnkAsRed = Glide_unk_as_red.Checked;
			ss.GlidePlugin.FbReadAlways = Glide_fb_read_always.Checked;
			ss.GlidePlugin.MotionBlur = Glide_motionblur.Checked;
			ss.GlidePlugin.FbRender = Glide_fb_render.Checked;
			...
			ss.GlidePlugin.DisableAuxBuf = Glide_disable_auxbuf.Checked;
			ss.GlidePlugin.FbGetInfo = Glide_fb_get_info.Checked;
			...
			ss.GlidePlugin.FbHiRes = Glide_fb_hires.Checked;
			ss.GlidePlugin.FbReadAlpha = Glide_fb_read_alpha.Checked;
			ss.GlidePlugin.FbSmart = Glide_fb_smart.Checked;
			ss.GlidePlugin.FillColorFix = Glide_fillcolor_fix.Checked;
			ss.GlidePlugin.Fog = Glide_fog.Checked;
			ss.GlidePlugin.ForceDepthCompare = Glide_force_depth_compare.Checked;
			ss.GlidePlugin.ForceMicroCheck = Glide_force_microcheck.Checked;
			ss.GlidePlugin.FbHiResBufClear = Glide_fb_hires_buf_clear.Checked;
			ss.GlidePlugin.FbIgnoreAuxCopy = Glide_fb_ignore_aux_copy.Checked;
			ss.GlidePlugin.FbIgnorePrevious = Glide_fb_ignore_previous.Checked;
			ss.GlidePlugin.IncreasePrimDepth = Glide_increase_primdepth.Checked;
			ss.GlidePlugin.IncreaseTexRectEdge = Glide_increase_texrect_edge.Checked;
			ss.GlidePlugin.FbOptimizeTexRect = Glide_fb_optimize_texrect.Checked;
			ss.GlidePlugin.FbOptimizeWrite = Glide_fb_optimize_write.Checked;
			ss.GlidePlugin.PPL = Glide_PPL.Checked;
			ss.GlidePlugin.SoftDepthCompare = Glide_soft_depth_compare.Checked;
			ss.GlidePlugin.UseSts1Only = Glide_use_sts1_only.Checked;
			ss.GlidePlugin.WrapBigTex = Glide_wrap_big_tex.Checked;
		...
		private void N64VideoPluginconfig_Load(object sender, EventArgs e)
		{
			...
			Glide_autodetect_ucode.Checked = ss.GlidePlugin.AutodetectUCode;
			Glide_ucode.SelectedIndex = ss.GlidePlugin.UCode;
			Glide_flame_corona.Checked = ss.GlidePlugin.FlameCorona;
			Glide_card_id.SelectedIndex = ss.GlidePlugin.CardId;
			Glide_tex_filter.SelectedIndex = ss.GlidePlugin.TexFilter;
			Glide_wireframe.Checked = ss.GlidePlugin.WireFrame;
			Glide_wfmode.SelectedIndex = ss.GlidePlugin.WFMode;
			Glide_fast_crc.Checked = ss.GlidePlugin.FastCRC;
			Glide_filter_cache.Checked = ss.GlidePlugin.FilterCache;
			Glide_unk_as_red.Checked = ss.GlidePlugin.UnkAsRed;
			Glide_fb_read_always.Checked = ss.GlidePlugin.FbReadAlways;
			Glide_motionblur.Checked = ss.GlidePlugin.MotionBlur;
			Glide_fb_render.Checked = ss.GlidePlugin.FbRender;
			...
			Glide_disable_auxbuf.Checked = ss.GlidePlugin.DisableAuxBuf;
			Glide_fb_get_info.Checked = ss.GlidePlugin.FbGetInfo;
			...
			if (!ss.GlidePlugin.UseDefaultHacks)
			{
				...
				Glide_fb_hires.Checked = ss.GlidePlugin.FbHiRes;
				Glide_fb_read_alpha.Checked = ss.GlidePlugin.FbReadAlpha;
				Glide_fb_smart.Checked = ss.GlidePlugin.FbSmart;
				Glide_fillcolor_fix.Checked = ss.GlidePlugin.FillColorFix;
				Glide_fog.Checked = ss.GlidePlugin.Fog;
				Glide_force_depth_compare.Checked = ss.GlidePlugin.ForceDepthCompare;
				Glide_force_microcheck.Checked = ss.GlidePlugin.ForceMicroCheck;
				Glide_fb_hires_buf_clear.Checked = ss.GlidePlugin.FbHiResBufClear;
				Glide_fb_ignore_aux_copy.Checked = ss.GlidePlugin.FbIgnoreAuxCopy;
				Glide_fb_ignore_previous.Checked = ss.GlidePlugin.FbIgnorePrevious;
				Glide_increase_primdepth.Checked = ss.GlidePlugin.IncreasePrimDepth;
				Glide_increase_texrect_edge.Checked = ss.GlidePlugin.IncreaseTexRectEdge;
				Glide_fb_optimize_texrect.Checked = ss.GlidePlugin.FbOptimizeTexRect;
				Glide_fb_optimize_write.Checked = ss.GlidePlugin.FbOptimizeWrite;
				Glide_PPL.Checked = ss.GlidePlugin.PPL;
				Glide_soft_depth_compare.Checked = ss.GlidePlugin.SoftDepthCompare;
				Glide_use_sts1_only.Checked = ss.GlidePlugin.UseSts1Only;
				Glide_wrap_big_tex.Checked = ss.GlidePlugin.WrapBigTex;
