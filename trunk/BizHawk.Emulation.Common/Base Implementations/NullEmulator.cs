...
namespace BizHawk.Emulation.Common
{
	...
	class Bell
	{
		...
		readonly static int[] AdaptationTable = { 230, 230, 230, 230, 307, 409, 512, 614, 768, 614, 512, 409, 307, 230, 230, 230 };
		readonly static int[] AdaptCoeff1 = { 256, 512, 0, 192, 240, 460, 392 };
		readonly static int[] AdaptCoeff2 = { 0, -256, 0, 64, 0, -208, -232 };
