...
//zero 04-nov-2012 - change the way this table is setup to actually compile under msvc in under 1000 years
//--------------
...
CTEntry PS_GPU::Commands_MAC_0[256] =
 #define BLENDMODE_MAC 0
 {
  #include "gpu_command_table.inc"
 };
...
CTEntry PS_GPU::Commands_MAC_1[256] =
 #define BLENDMODE_MAC 1
 {
  #include "gpu_command_table.inc"
 };
...
CTEntry PS_GPU::Commands_MAC_2[256] =
 #define BLENDMODE_MAC 2
 {
  #include "gpu_command_table.inc"
 };
...
CTEntry PS_GPU::Commands_MAC_3[256] =
 #define BLENDMODE_MAC 3
 {
  #include "gpu_command_table.inc"
 };
...
CTEntry* PS_GPU::Commands[4] = { Commands_MAC_0, Commands_MAC_1, Commands_MAC_2, Commands_MAC_3 };
