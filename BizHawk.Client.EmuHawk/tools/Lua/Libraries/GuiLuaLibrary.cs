...
namespace BizHawk.Client.EmuHawk
{
	public sealed class GuiLuaLibrary : DelegatingLuaLibraryEmu, IDisposable
	{
		...
		public void SetDefaultForegroundColor(Color color) => APIs.Gui.DefaultForegroundColor = color;
		...
		public void SetDefaultBackgroundColor(Color color) => APIs.Gui.DefaultBackgroundColor = color;
		...
		public void SetDefaultTextBackground(Color color) => APIs.Gui.DefaultTextBackground = color;
		...
		public void SetDefaultPixelFont(string fontfamily) => APIs.Gui.DefaultPixelFont = fontfamily;
		...
		public void DrawText(int x, int y, string message, Color? forecolor = null, Color? backcolor = null, string fontfamily = null) => APIs.Gui.DrawText(x, y, message, forecolor, backcolor ?? APIs.Gui.DefaultTextBackground, fontfamily);
