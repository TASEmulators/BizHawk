...
{
	public const string Mainversion = "2.1.1"; // Use numbers only or the new version notification won't work
	public static readonly string RELEASEDATE = "July 23, 2017";
