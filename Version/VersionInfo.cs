...
{
	public const string Mainversion = "1.12.2"; // Use numbers only or the new version notification won't work

	public static readonly string RELEASEDATE = "May 3, 2017";
