...
void GetFileBase(const char *f)
{
     ...
     {
      char *tmpfn = new char[tp1 - f + 1]; //zero 07-feb-2012 - removed dynamic stack buffer
     ...
     {
      char *tmpbase = new char[tp3 - tp1 + 1]; //zero 07-feb-2012 - removed dynamic stack buffer
