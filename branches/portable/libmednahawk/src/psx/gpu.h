...
class PS_GPU
{
 ...
 static CTEntry* Commands[4]; 
 static CTEntry Commands_MAC_0[256];
 static CTEntry Commands_MAC_1[256];
 static CTEntry Commands_MAC_2[256];
 static CTEntry Commands_MAC_3[256];
