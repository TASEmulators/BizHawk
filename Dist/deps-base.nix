  ...
  sublist =
    ...
    builtins.genList
      ...
      (if start >= len then 0
       ...
       imap0 = f: list: builtins.genList (n: f n (builtins.elemAt list n)) (builtins.length list);
in
let
	since-2_7 = [
		...
		({ pname = "OpenTK"; version = "3.3.3"; sha256 = "sha256-af/N1n+Wg/vdN9Q1fiyER5061oyimkPCbd+Wxis7Zqk="; })
		({ pname = "OpenTK.GLControl"; version = "3.3.3"; sha256 = "sha256-Fc+gxYV4JNHe0ylxn5GnXxasIjLDzvVzxcRN6qf3iVk="; })
	...
	until-2_8 = [
		({ pname = "Microsoft.AspNetCore.App.Ref"; version = "5.0.0"; sha256 = "0d7sjr89zwq0wxirf8la05hfalv9nhvlczg1c7a508k8aw79jvfg"; })
	...
	until-2_9 = [
		({ pname = "Menees.Analyzers"; version = "2.0.4"; sha256 = "0nvg9jw99066cf3aqg3iqllsabq8l100wbki62yq8ldmqlygg0wr"; })
		...
		({ pname = "StyleCop.Analyzers"; version = "1.2.0-beta.333"; sha256 = "0ayfbwm5lqw0y9gshvdw1a0jym21bzrw7qv41n504hnq3sjdxjh6"; })
		({ pname = "StyleCop.Analyzers.Unstable"; version = "1.2.0.333"; sha256 = "04jkfv3azqvd1nd2fsi0gi3mcrxjj9cf5cmavhbcqc5ibjjrarjz"; })
	...
	since-2_9 = [
		...
		({ pname = "Microsoft.AspNetCore.App.Ref"; version = "6.0.9"; sha256 = "16zdir94cacz2qrndspkyvwq7gp0cp20wdixkazfzxk8h5fhgbzw"; })
	...
	f = i: builtins.foldl' (a: b: a ++ b) [] (sublist i versionCount partialLists);
in assert (builtins.length partialLists) == versionCount * 2 - 1;
	builtins.listToAttrs (imap0 (i: name: { inherit name; value = f i; }) versions)
