...
--:|:--|:--|:--
2.11.2 dev (CWD) | `bizhawkAssemblies` | `emuhawk` | `discohawk`
2.11.1 | (`bizhawkAssemblies-latest-bin`&nbsp;=&nbsp;) `bizhawkAssemblies-2_11_1-bin` | (`emuhawk-latest-bin`&nbsp;=&nbsp;) `emuhawk-2_11_1-bin` | (`discohawk-latest-bin`&nbsp;=&nbsp;) `discohawk-2_11_1-bin`
2.11.1 from source | (`bizhawkAssemblies-latest`&nbsp;=&nbsp;) `bizhawkAssemblies-2_11_1` | (`emuhawk-latest`&nbsp;=&nbsp;) `emuhawk-2_11_1` | (`discohawk-latest`&nbsp;=&nbsp;) `discohawk-2_11_1`
|||
2.11 | `bizhawkAssemblies-2_11-bin` | `emuhawk-2_11-bin` | DIY
2.11 from source | DIY | `emuhawk-2_11` | DIY
