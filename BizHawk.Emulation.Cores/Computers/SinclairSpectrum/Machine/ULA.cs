						...
						(pix >= _ula.FirstPaperTState) && (pix < (_ula.FirstPaperTState + 128)))
					{
						...
						switch (scrPix & 7)
						{
							case 0:
								...
								Renderer[item].ByteAddress = CalculateByteAddress(scrPix + 4, scrLin); // +4 = prefetch!
								break;
							case 1:
								Renderer[item].RAction = RenderAction.Shift1AndFetchAttribute2; // shift 1 + fetch A2
								Renderer[item].AttributeAddress = CalculateAttributeAddress(scrPix + 3, scrLin); // +3 = prefetch!
								break;
							case 2:
							...
							case 6:
								...
								Renderer[item].ByteAddress = CalculateByteAddress(scrPix + 2, scrLin); // +2 = prefetch!
								break;
							case 7:
								if (pix < (_ula.FirstPaperTState + 128 - 2))
								{
								...
								Renderer[item].AttributeAddress = CalculateAttributeAddress(scrPix + 1, scrLin); // +1 = prefetch!
								break;
						}
					}
