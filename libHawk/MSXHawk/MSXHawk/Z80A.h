...
namespace MSXHawk
{
	...
	public:
		...
		uint32_t NoIndexIRQS[256] = {};
		uint32_t CBIndexIRQS[256] = {};
		uint32_t EXTIndexIRQS[256] = {};
		uint32_t IXIndexIRQS[256] = {};
		uint32_t IYIndexIRQS[256] = {};
		uint32_t IXYCBIndexIRQS[256] = {};

		uint32_t NoIndex[256 * 38] = {};
		uint32_t CBIndex[256 * 38] = {};
		uint32_t EXTIndex[256 * 38] = {};
		uint32_t IXIndex[256 * 38] = {};
		uint32_t IYIndex[256 * 38] = {};
		uint32_t IXYCBIndex[256 * 38] = {};

		uint32_t NoIndexBUSRQ[256 * 19] = {};
		uint32_t CBIndexBUSRQ[256 * 19] = {};
		uint32_t EXTIndexBUSRQ[256 * 19] = {};
		uint32_t IXIndexBUSRQ[256 * 19] = {};
		uint32_t IYIndexBUSRQ[256 * 19] = {};
		uint32_t IXYCBIndexBUSRQ[256 * 19] = {};

		uint32_t NoIndexMEMRQ[256 * 19] = {};
		uint32_t CBIndexMEMRQ[256 * 19] = {};
		uint32_t EXTIndexMEMRQ[256 * 19] = {};
		uint32_t IXIndexMEMRQ[256 * 19] = {};
		uint32_t IYIndexMEMRQ[256 * 19] = {};
		uint32_t IXYCBIndexMEMRQ[256 * 19] = {};
		...
		const static uint32_t FLAG_P = 6;
		const static uint32_t FLAG_NP = 7;
		const static uint32_t FLAG_S = 8;
		const static uint32_t FLAG_NS = 9;
		const static uint32_t B_ZERO = 10;
		...
		const static uint32_t PREFT_ASGN = 76;
		const static uint32_t PREX_ASGN = 77;
		const static uint32_t JP_COND_TR = 78;
		const static uint32_t ASGN_B = 79;
		const static uint32_t COND_CHK = 80;
		...
		// reset
		uint32_t Reset_CPU[7] = { IDLE,
								DEC16, F, A,
								DEC16, SPl, SPh };

		uint32_t Reset_BUSRQ[3] = { 0, 0, 0 };
		uint32_t Reset_MEMRQ[3] = { 0, 0, 0 };
		uint32_t Reset_IRQS = 3;

		// ld_op_r
		uint32_t LD_OP_R_INST[17] = { DEC16, PCl, PCh,
									DEC16, PCl, PCh,
									TR16, Z, W, PCl, PCh,
									INC16, Z, W,
									Ztemp2, E, D };
		
		uint32_t LD_OP_R_BUSRQ[5] = { D, D, D, D, D };
		uint32_t LD_OP_R_MEMRQ[5] = { 0, 0, 0, 0, 0 };
		uint32_t LD_OP_R_IRQS = 5;

		// ld_cp_r
		uint32_t LD_CP_R_INST[17] = { DEC16, PCl, PCh,
									DEC16, PCl, PCh,
									TR16, Z, W, PCl, PCh,
									INC16, Z, W,
									Ztemp2, L, H };

		uint32_t LD_CP_R_BUSRQ[5] = { H, H, H, H, H };
		uint32_t LD_CP_R_MEMRQ[5] = { 0, 0, 0, 0, 0 };
		uint32_t LD_CP_R_IRQS = 5;

		// rep_op_i
		uint32_t REP_OP_I_INST[11] = { IDLE,
									IDLE,
									DEC16, PCl, PCh,
									DEC16, PCl, PCh,
									Ztemp2, L, H };

		uint32_t REP_OP_I_BUSRQ[5] = { H, H, H, H, H };
		uint32_t REP_OP_I_MEMRQ[5] = { 0, 0, 0, 0, 0 };
		uint32_t REP_OP_I_IRQS = 5;

		// rep_op_o
		uint32_t REP_OP_O_INST[11] = { IDLE,
									IDLE,
									DEC16, PCl, PCh,
									DEC16, PCl, PCh,
									IDLE };

		uint32_t REP_OP_O_BUSRQ[5] = { B, B, B, B, B };
		...
		void I_INT_OP(uint32_t operation, uint32_t dest)
		{
			...
			PopulateBUSRQ(PCh, W, 0, 0, W, W, 0, 0);
		...
		void DJNZ_()
		{
			PopulateCURINSTR(COND_CHK, B_ZERO, 0,
							IDLE,
							ASGN_B,
							WAIT,
							RD_INC, ALU, PCl, PCh,
		...
		{
			PopulateCURINSTR(COND_CHK, cond, 1,
							IDLE,
							WAIT,
							RD_INC, ALU, PCl, PCh,
							IDLE,
		...
		{
			PopulateCURINSTR(COND_CHK, cond, 2,
							IDLE,
							WAIT,
							RD_INC, Z, PCl, PCh,
							IDLE,
							WAIT,
							JP_COND_TR, Z, W, PCl, PCh);
		...
		{
			PopulateCURINSTR(COND_CHK, cond, 3,
							IDLE,
							IDLE,
							WAIT,
							RD_INC, Z, SPl, SPh,
		...
		{
			PopulateCURINSTR(COND_CHK, cond, 4,
							IDLE,
							WAIT,
							RD_INC, Z, PCl, PCh,
							IDLE,
		...
		{
			PopulateCURINSTR(PREX_ASGN, src,
							IDLE,
							WAIT,
							PREFIX);
		...
		{
			PopulateCURINSTR(PREFT_ASGN, src,
							PREX_ASGN, src,
							WAIT,
							RD_INC, ALU, PCl, PCh,
							ADDS, Z, W, ALU, ZERO,
