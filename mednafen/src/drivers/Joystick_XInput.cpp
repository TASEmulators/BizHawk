...
{
 void (WINAPI *p_XInputEnable)(BOOL); //zero 29-oct-2012 - change location of WINAPI to make compile in msvc
 DWORD (WINAPI *p_XInputSetState)(DWORD, XINPUT_VIBRATION*); //zero 29-oct-2012 - change location of WINAPI to make compile in msvc
 DWORD (WINAPI *p_XInputGetState)(DWORD, XINPUT_STATE*); //zero 29-oct-2012 - change location of WINAPI to make compile in msvc
 DWORD (WINAPI *p_XInputGetCapabilities)(DWORD, DWORD, XINPUT_CAPABILITIES*); //zero 29-oct-2012 - change location of WINAPI to make compile in msvc
};
