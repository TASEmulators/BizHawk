...
//static MultiAccessSizeMem<1024, uint32, false, PS_CPU::FAST_MAP_TRAMPOLINE_SIZE / 4, PS_CPU::FAST_MAP_TRAMPOLINE_SIZE / 4> ScratchRAM; //zero 01-apr-2012 - add padding here
