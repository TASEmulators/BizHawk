...
enum ExtraButtons
{
  BUTTON_INVENTORY_LEFT  = 0b0000000000001000,
  BUTTON_INVENTORY_RIGHT = 0b0000000000010000,
  BUTTON_INVENTORY_SKIP  = 0b0000000000100000,
  BUTTON_ARTIFACT_USE    = 0b0000000001000000,
  BUTTON_LOOK_UP         = 0b0000000010000000,
  BUTTON_LOOK_DOWN       = 0b0000000100000000,
  BUTTON_LOOK_CENTER     = 0b0000001000000000,
  BUTTON_FLY_UP          = 0b0000010000000000,
  BUTTON_FLY_DOWN        = 0b0000100000000000,
  BUTTON_FLY_CENTER      = 0b0001000000000000,
