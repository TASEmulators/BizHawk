...
ECL_EXPORT void GetMemoryAreas(MemoryArea* m)
{
	...
	AddMemoryDomain("Work Ram Low", WorkRAML, sizeof(WorkRAML), MEMORYAREA_FLAGS_SWAPPED |MEMORYAREA_FLAGS_WRITABLE | MEMORYAREA_FLAGS_YUGEENDIAN | MEMORYAREA_FLAGS_WORDSIZE2);
	AddMemoryDomain("Work Ram High", WorkRAMH, sizeof(WorkRAMH), MEMORYAREA_FLAGS_SWAPPED | MEMORYAREA_FLAGS_WRITABLE | MEMORYAREA_FLAGS_YUGEENDIAN | MEMORYAREA_FLAGS_WORDSIZE2 | MEMORYAREA_FLAGS_PRIMARY);
	AddMemoryDomain("VDP1 Ram", VDP1::VRAM, sizeof(VDP1::VRAM),  MEMORYAREA_FLAGS_SWAPPED | MEMORYAREA_FLAGS_WRITABLE | MEMORYAREA_FLAGS_YUGEENDIAN | MEMORYAREA_FLAGS_WORDSIZE2);
	...
	AddMemoryDomain("VDP2 Ram", VDP2::VRAM, sizeof(VDP2::VRAM),  MEMORYAREA_FLAGS_SWAPPED | MEMORYAREA_FLAGS_WRITABLE | MEMORYAREA_FLAGS_YUGEENDIAN | MEMORYAREA_FLAGS_WORDSIZE2);
