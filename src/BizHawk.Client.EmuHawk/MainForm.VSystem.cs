...
namespace BizHawk.Client.EmuHawk
{
	public partial class MainForm
	{
		...
		private void Mupen64SettingsMenuItem_Click(object sender, EventArgs e)
			=> OpenGenericCoreConfigFor<Mupen64>(CoreNames.Mupen64Plus + " Settings");

		private void Mupen64SubMenu_DropDownOpened(object sender, EventArgs e)
			=> Mupen64CircularAnalogRangeMenuItem.Checked = Config.N64UseCircularAnalogConstraint;
...
//					SupportMultiDottedExtensions = true, // I think this should be enabled globally if we're going to do it --yoshi
		...
		private IReadOnlyCollection<ToolStripItem> CreateCoreSettingsSubmenus(bool includeDupes = false)
		{
			...
			var ares64Submenu = CreateCoreSubmenu(VSystemCategory.Consoles, CoreNames.Ares64, CreateGenericCoreConfigItem<Ares64>(CoreNames.Ares64), ares64AnalogConstraintItem);
			...
			var mupen64PlusSubmenu = CreateCoreSubmenu(VSystemCategory.Consoles, CoreNames.Mupen64Plus, CreateGenericCoreConfigItem<Mupen64>(CoreNames.Mupen64Plus), mupen64PlusAnalogConstraintItem);
			mupen64PlusSubmenu.DropDownOpened += (_, _) => mupen64PlusAnalogConstraintItem.Checked = Config.N64UseCircularAnalogConstraint;
		...
		private void HandlePlatformMenus()
		{
			...
			switch (sysID)
			{
				...
				case VSystemID.Raw.INTV:
					...
					break;
				case VSystemID.Raw.N64 when Emulator is Mupen64:
