namespace BizHawk.Client.EmuHawk
{
	partial class N64VideoPluginConfig
	{
		...
		private void InitializeComponent()
		{
			...
			// GLideN64Tab
			// 
			this.GLideN64Tab.Controls.Add(this.GlideN64PropertyGrid);
			...
			// Glide64mk2TabPage
			// 
			this.Glide64mk2TabPage.Controls.Add(this.Glide64Mk2PropertyGrid);
			...
			// Glide64TabPage
			// 
			this.Glide64TabPage.Controls.Add(this.GlidePropertyGrid);
			...
			// RiceTabPage
			// 
			this.RiceTabPage.Controls.Add(this.RicePropertyGrid);
			...
			this.RicePropertyGrid.Size = new System.Drawing.Size(566, 337);
			this.RicePropertyGrid.TabIndex = 0;
			// 
			// GlidePropertyGrid
			// 
			this.GlidePropertyGrid.Location = new System.Drawing.Point(3, 3);
			this.GlidePropertyGrid.Name = "GlidePropertyGrid";
			this.GlidePropertyGrid.Size = new System.Drawing.Size(566, 337);
			this.GlidePropertyGrid.TabIndex = 1;
			// 
			// Glide64Mk2PropertyGrid
			// 
			this.Glide64Mk2PropertyGrid.Location = new System.Drawing.Point(3, 3);
			this.Glide64Mk2PropertyGrid.Name = "Glide64Mk2PropertyGrid";
			this.Glide64Mk2PropertyGrid.Size = new System.Drawing.Size(566, 337);
			this.Glide64Mk2PropertyGrid.TabIndex = 2;
			// 
			// GlideN64PropertyGrid
			// 
			this.GlideN64PropertyGrid.Location = new System.Drawing.Point(3, 3);
			this.GlideN64PropertyGrid.Name = "GlideN64PropertyGrid";
