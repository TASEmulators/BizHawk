...
namespace BizHawk.Tests.Client.Common.config
{
	...
	public sealed class SerializationStabilityTests
	{
		...
		private static readonly IReadOnlyDictionary<Type, string> KnownGoodFromBizHawk = new Dictionary<Type, string>
		{
			...
			[typeof(RewindConfig)] = @"{""UseCompression"":false,""UseDelta"":false,""Enabled"":true,""AllowSlowStates"":false,""BufferSize"":512,""UseFixedRewindInterval"":false,""TargetFrameLength"":600,""TargetRewindInterval"":5,""SpeedMultiplier"":2,""FastSpeedMultiplier"":7,""AllowOutOfOrderStates"":true,""BackingStore"":0}",
