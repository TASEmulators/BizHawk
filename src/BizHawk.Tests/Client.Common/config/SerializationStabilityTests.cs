...
namespace BizHawk.Tests.Client.Common.config
{
	...
	public sealed class SerializationStabilityTests
	{
		...
		private static readonly IReadOnlyDictionary<Type, string> KnownGoodFromBizHawk = new Dictionary<Type, string>
		{
			...
			[typeof(SaveStateConfig)] = @"{""Type"":0,""CompressionLevelNormal"":1,""CompressionLevelRewind"":0,""MakeBackups"":true,""SaveScreenshot"":true,""BigScreenshotSize"":131072,""NoLowResLargeScreenshots"":false,""AutoSaveStateOnExit"":false,""AutoSaveStateSlot"":0}",
