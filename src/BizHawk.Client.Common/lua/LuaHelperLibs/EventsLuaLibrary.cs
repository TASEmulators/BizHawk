...
namespace BizHawk.Client.Common
{
	...
	public sealed class EventsLuaLibrary : LuaLibraryBase
	{
		...
		public string OnFrameEnd(LuaFunction luaf, string name = null)
			=> CreateAndRegisterNamedFunction(luaf, NamedLuaFunction.EVENT_TYPE_POSTFRAME, CurrentFile, name: name)
				.GuidStr;
		...
		public string OnFrameStart(LuaFunction luaf, string name = null)
			=> CreateAndRegisterNamedFunction(luaf, NamedLuaFunction.EVENT_TYPE_PREFRAME, CurrentFile, name: name)
				.GuidStr;
		...
		{
			var nlf = CreateAndRegisterNamedFunction(luaf, NamedLuaFunction.EVENT_TYPE_INPUTPOLL, CurrentFile, name: name);
		...
		public string OnLoadState(LuaFunction luaf, string name = null)
			=> CreateAndRegisterNamedFunction(luaf, NamedLuaFunction.EVENT_TYPE_LOADSTATE, CurrentFile, name: name)
				.GuidStr;
			...
			string scope = null)
		{
			try
			{
					...
					&& DebuggableCore.MemoryCallbacks.ExecuteCallbacksAvailable)
				{
					...
					var nlf = CreateAndRegisterNamedFunction(luaf, NamedLuaFunction.EVENT_TYPE_MEMEXEC, CurrentFile, name: name);
			...
			string scope = null)
		{
			try
			{
					...
					&& DebuggableCore.MemoryCallbacks.ExecuteCallbacksAvailable)
				{
					...
					var nlf = CreateAndRegisterNamedFunction(luaf, NamedLuaFunction.EVENT_TYPE_MEMEXECANY, CurrentFile, name: name);
			...
			string scope = null)
		{
			try
			{
				if (DebuggableCore?.MemoryCallbacksAvailable() == true)
				{
					...
					var nlf = CreateAndRegisterNamedFunction(luaf, NamedLuaFunction.EVENT_TYPE_MEMREAD, CurrentFile, name: name);
...
//			Log("Deprecated function event.onmemorywrite(...) used, replace the call with event.on_bus_write(...).");
			...
			string scope = null)
		{
			try
			{
				if (DebuggableCore?.MemoryCallbacksAvailable() == true)
				{
					...
					var nlf = CreateAndRegisterNamedFunction(luaf, NamedLuaFunction.EVENT_TYPE_MEMWRITE, CurrentFile, name: name);
		...
		public string OnSaveState(LuaFunction luaf, string name = null)
			=> CreateAndRegisterNamedFunction(luaf, NamedLuaFunction.EVENT_TYPE_SAVESTATE, CurrentFile, name: name)
				.GuidStr;
		...
		public string OnExit(LuaFunction luaf, string name = null)
			=> CreateAndRegisterNamedFunction(luaf, NamedLuaFunction.EVENT_TYPE_ENGINESTOP, CurrentFile, name: name)
				.GuidStr;
		...
		public string OnConsoleClose(LuaFunction luaf, string name = null)
			=> CreateAndRegisterNamedFunction(luaf, NamedLuaFunction.EVENT_TYPE_CONSOLECLOSE, CurrentFile, name: name)
				.GuidStr;
