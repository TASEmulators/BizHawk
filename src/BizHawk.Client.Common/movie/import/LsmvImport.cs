...
namespace BizHawk.Client.Common.movie.import
{
	...
	internal class LsmvImport : MovieImporter
	{
		...
		protected override void RunImport()
		{
			...
			_emptyController = new SimpleLogEntryController(controllerDefinition, VSystemID.Raw.SNES);
			_controller = new SimpleLogEntryController(controllerDefinition, VSystemID.Raw.SNES);
