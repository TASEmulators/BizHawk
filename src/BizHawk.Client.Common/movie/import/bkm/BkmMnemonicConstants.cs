...
namespace BizHawk.Client.Common
{
	...
	{
		public static readonly Dictionary<string, Dictionary<string, string>> Buttons = new()
		{
		...
		public static readonly Dictionary<string, Dictionary<string, string>> Analogs = new()
		{
			["Nintendo 64 Controller"] = new Dictionary<string, string> { ["X Axis"] = "X" , ["Y Axis"] = "Y" }
		};

		public static readonly Dictionary<string, Dictionary<string, string>> Commands = new()
		{
		...
		public static readonly Dictionary<string, int> Players = new()
		{
