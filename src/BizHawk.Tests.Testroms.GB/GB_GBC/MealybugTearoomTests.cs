	...
	public sealed class MealybugTearoomTests
	{
		public readonly struct MealybugTestCase
		{
			...
			public static readonly IReadOnlyList<string> KnownFailures = new[]
			{
				...
				"m3_lcdc_bg_map_change on DMG in SameBoy",
				"m3_lcdc_bg_map_change on DMG in SameBoy (no BIOS)",
				...
				"m3_lcdc_tile_sel_change on DMG in SameBoy",
				"m3_lcdc_tile_sel_change on DMG in SameBoy (no BIOS)",
				...
				"m3_lcdc_tile_sel_win_change on DMG in SameBoy",
				"m3_lcdc_tile_sel_win_change on DMG in SameBoy (no BIOS)",
				...
				"m3_lcdc_win_map_change on DMG in SameBoy",
				"m3_lcdc_win_map_change on DMG in SameBoy (no BIOS)",
				...
				"m3_scy_change on DMG in SameBoy",
				"m3_scy_change on DMG in SameBoy (no BIOS)",
