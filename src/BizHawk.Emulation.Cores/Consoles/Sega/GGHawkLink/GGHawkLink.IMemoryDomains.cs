...
namespace BizHawk.Emulation.Cores.Sega.GGHawkLink
{
	public partial class GGHawkLink
	{
		...
		public void SetupMemoryDomains()
		{
			...
			if (L.SaveRAM != null)
			{
				MemoryDomainByteArray cartRamL = new("Cart RAM L", MemoryDomain.Endian.Little, L.SaveRAM, true, 1);
				domains.Add(cartRamL);
			}

			if (R.SaveRAM != null)
			{
				MemoryDomainByteArray cartRamR = new("Cart RAM R", MemoryDomain.Endian.Little, R.SaveRAM, true, 1);
