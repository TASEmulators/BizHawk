	...
	public partial class GBHawk
	{
		public byte Read_Registers(int addr)
		{
			...
			switch (addr)
			{
				...
				case 0xFF76:
					byte ret1 = audio.SQ1_output >= Audio.DAC_OFST
						? (byte) (audio.SQ1_output - Audio.DAC_OFST)
						: (byte) 0;
					byte ret2 = audio.SQ2_output >= Audio.DAC_OFST
				...
				case 0xFF77:
					byte retN = audio.NOISE_output >= Audio.DAC_OFST
						? (byte) (audio.NOISE_output - Audio.DAC_OFST)
						: (byte) 0;
					byte retW = audio.WAVE_output >= Audio.DAC_OFST
