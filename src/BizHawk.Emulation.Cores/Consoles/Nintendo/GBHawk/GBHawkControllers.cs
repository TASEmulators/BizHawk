...
namespace BizHawk.Emulation.Cores.Nintendo.GBHawk
{
	...
	public class StandardTilt : IPort
	{
		...
		public (ushort X, ushort Y) ReadAcc(IController c)
		{
			...
			ushort accX = (ushort) (0x8370 - Math.Floor(temp * 216) - temp2);

			// acc y is just the sine of the angle
			float temp3 = (float) Math.Sin(theta);
			...
			float temp4 = (float) (Math.Pow((theta - theta_prev) * 59.7275, 2) * 0.15);
			ushort accY = (ushort) (0x8370 - Math.Floor(temp3 * 216) + temp4);
