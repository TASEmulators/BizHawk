...
namespace BizHawk.Emulation.Cores.Nintendo.GBHawkLink
{
		...
		ILinkedGameBoyCommon
	{
		...
		public GBHawkLink(CoreLoadParameters<GBHawkLink.GBLinkSettings, GBHawkLink.GBLinkSyncSettings> lp)
		{
			...
			GBHawk.GBHawk.GBSettings temp_set_L = new GBHawk.GBHawk.GBSettings();
			GBHawk.GBHawk.GBSettings temp_set_R = new GBHawk.GBHawk.GBSettings();

			GBHawk.GBHawk.GBSyncSettings temp_sync_L = new GBHawk.GBHawk.GBSyncSettings();
			GBHawk.GBHawk.GBSyncSettings temp_sync_R = new GBHawk.GBHawk.GBSyncSettings();
