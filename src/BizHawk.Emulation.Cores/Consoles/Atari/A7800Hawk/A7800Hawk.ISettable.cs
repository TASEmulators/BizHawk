...
namespace BizHawk.Emulation.Cores.Atari.A7800Hawk
{
	...
	{
		public A7800Settings GetSettings() => _settings.Clone();

		public A7800SyncSettings GetSyncSettings() => _syncSettings.Clone();
		...
		{
			public A7800Settings Clone() => (A7800Settings)MemberwiseClone();
		...
		public class A7800SyncSettings
		{
			...
			public A7800SyncSettings Clone() => (A7800SyncSettings)MemberwiseClone();
			...
			public static bool NeedsReboot(A7800SyncSettings x, A7800SyncSettings y) => !DeepEquality.DeepEquals(x, y);
		}
	}
}
