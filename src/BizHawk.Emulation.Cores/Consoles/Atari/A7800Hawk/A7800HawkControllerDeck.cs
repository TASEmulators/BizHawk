...
namespace BizHawk.Emulation.Cores.Atari.A7800Hawk
{
	public class A7800HawkControllerDeck
	{
		...
		public byte ReadFire1(IController c) => Port1.ReadFire(c);

		public byte ReadFire2(IController c) => Port2.ReadFire(c);

		public byte ReadFire1_2x(IController c) => Port1.ReadFire2x(c);

		public byte ReadFire2_2x(IController c) => Port2.ReadFire2x(c);

		public bool Is_2_button1(IController c) => Port1.Is_2_button(c);

		public bool Is_2_button2(IController c) => Port2.Is_2_button(c);

		public bool Is_LightGun1(IController c, out float lightgun_x, out float lightgun_y) => Port1.Is_LightGun(c, out lightgun_x, out lightgun_y);

		public bool Is_LightGun2(IController c, out float lightgun_x, out float lightgun_y) => Port2.Is_LightGun(c, out lightgun_x, out lightgun_y);
