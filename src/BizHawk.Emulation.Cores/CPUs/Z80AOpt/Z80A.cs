...
namespace BizHawk.Emulation.Cores.Components.Z80AOpt
{
	...
	public sealed partial class Z80AOpt<TLink> where TLink : IZ80ALink
	{
		...
		{
			// Bounds-check elimination for the per-cycle micro-op reads: take one ref to element 0
			// (a single bounds check) and index off it with Unsafe.Add (no per-access check). The
			// ref is re-derived every call, so it stays valid across savestate array replacement.
			// Indices are bounded by the instruction builders exactly as before, so this is safe.
			ref ushort ci0 = ref cur_instr[0];
			bus_pntr++; mem_pntr++;
			switch (Unsafe.Add(ref ci0, instr_pntr++))
			{
				case IDLE:
					// do nothing
					break;
				...
				case HALT:
					...
					break;
				case RD:
					Read_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case WR:
					Write_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case RD_INC:
					Read_INC_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case RD_INC_TR_PC:
					Read_INC_TR_PC_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case RD_OP:
					if (Unsafe.Add(ref ci0, instr_pntr++) == 1) { Read_INC_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++)); }
					else { Read_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++)); }

					switch (Unsafe.Add(ref ci0, instr_pntr++))
					{
						case ADD8:
							ADD8_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
							break;
						case ADC8:
							ADC8_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
							break;
						case SUB8:
							SUB8_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
							break;
						case SBC8:
							SBC8_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
							break;
						case AND8:
							AND8_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
							break;
						case XOR8:
							XOR8_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
							break;
						case OR8:
							OR8_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
							break;
						case CP8:
							CP8_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
							break;
						case TR:
							TR_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
							break;
					}
					break;
				case WR_INC:
					Write_INC_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case WR_DEC:
					Write_DEC_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case WR_TR_PC:
					Write_TR_PC_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case WR_INC_WA:
					Write_INC_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					Regs[W] = Regs[A];
				...
				case TR:
					...
					break;
				case TR16:
					TR16_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case ADD16:
					ADD16_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case ADD8:
					ADD8_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				...
				case ADC8:
					...
					break;
				case ADC16:
					ADC_16_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case SBC8:
					SBC8_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case SBC16:
					SBC_16_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case INC16:
					INC16_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case INC8:
					INC8_Func(Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case DEC16:
					DEC16_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case DEC8:
					DEC8_Func(Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case RLC:
					RLC_Func(Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case RL:
					RL_Func(Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case RRC:
					RRC_Func(Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case RR:
					RR_Func(Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case CPL:
					CPL_Func(Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case DA:
					DA_Func(Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case SCF:
					SCF_Func(Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case CCF:
					CCF_Func(Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case AND8:
					AND8_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				...
				case CP8:
					...
					break;
				case SLA:
					SLA_Func(Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case SRA:
					SRA_Func(Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case SRL:
					SRL_Func(Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case SLL:
					SLL_Func(Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case BIT:
					BIT_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case I_BIT:
					I_BIT_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case RES:
					RES_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case SET:
					SET_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case EI:
					EI_pending = 2;
					break;
				...
				case EXX:
					...
					break;
				case EXCH_16:
					EXCH_16_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case PREFIX:
					...
					break;
				case ASGN:
					ASGN_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case ADDS:
					ADDS_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case EI_RETI:
				...
				case EI_RETN:
					...
					break;
				case OUT:
					OUT_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case OUT_INC:
					OUT_INC_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case IN:
					IN_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case IN_INC:
					IN_INC_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case IN_A_N_INC:
					IN_A_N_INC_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case NEG:
					NEG_8_Func(Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case INT_MODE:
					interruptMode = Unsafe.Add(ref ci0, instr_pntr++);
					break;
				case RRD:
					RRD_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case RLD:
					RLD_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));
					break;
				case SET_FL_LD_R:
					DEC16_Func(C, B);
					SET_FL_LD_Func();

					Ztemp1 = Unsafe.Add(ref ci0, instr_pntr++);
					Ztemp2 = Unsafe.Add(ref ci0, instr_pntr++);
					Ztemp3 = Unsafe.Add(ref ci0, instr_pntr++);
				...
				case SET_FL_CP_R:
					...
					break;
				case SET_FL_IR:
					ushort dest_t = Unsafe.Add(ref ci0, instr_pntr++);
					TR_Func(dest_t, Unsafe.Add(ref ci0, instr_pntr++));
				...
				case WAIT:
					...
					break;
				case RST:
					Regs[Z] = Unsafe.Add(ref ci0, instr_pntr++);
					Regs[W] = 0;
					break;
				case REP_OP_I:
					Write_Func(Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++), Unsafe.Add(ref ci0, instr_pntr++));

					Ztemp4 = Unsafe.Add(ref ci0, instr_pntr++);
					if (Ztemp4 == DEC16)
					{
						TR16_Func(Z, W, C, B);
						DEC16_Func(Z, W);
		...
		{
			ser.BeginSection(nameof(Z80AOpt));
