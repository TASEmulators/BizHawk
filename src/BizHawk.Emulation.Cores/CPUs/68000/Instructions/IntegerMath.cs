...
namespace BizHawk.Emulation.Cores.Components.M68000
{
	partial class MC68000
	{
				...
				case 0: // byte
					{
						...
						X = C = (uresult & 0x100) != 0;
						V = result is > sbyte.MaxValue or < sbyte.MinValue;
						N = (result & 0x80) != 0;
						Z = result == 0;
				...
				case 1: // word
					{
						...
						V = result is > short.MaxValue or < short.MinValue;
						N = (result & 0x8000) != 0;
						Z = result == 0;
				...
				case 2: // long
					{
						...
						V = result is > int.MaxValue or < int.MinValue;
		...
		private void DIVU()
		{
			...
			V = ((int)quotient is < short.MinValue or > short.MaxValue);
			N = (quotient & 0x8000) != 0;
			Z = quotient == 0;
			C = false;
		...
		private void DIVS()
		{
			...
			V = (quotient is < short.MinValue or > short.MaxValue);
			N = (quotient & 0x8000) != 0;
			Z = quotient == 0;
			C = false;
