...
namespace BizHawk.Emulation.Cores.Floppy
{
	...
	/// SCP stores several revolutions of each track (header byte 5). We decode every revolution and let
	...
	/// only weaken sectors that fail their data CRC (a solid read is left solid).
	/// </summary>
