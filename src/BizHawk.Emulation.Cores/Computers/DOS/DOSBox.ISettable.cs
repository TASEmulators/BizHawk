...
namespace BizHawk.Emulation.Cores.Computers.DOS
{
	public partial class DOSBox : ISettable<object, DOSBox.SyncSettings>
	{
		...
		public class SyncSettings
		{
			...
			[Description("For absolute mouse inputs, this value allows adjusting the mapping (in pixels) between the mouse's absolute horizontal position on the Bizhawk window and that of the game.")]
			...
			[Description("For absolute mouse inputs, this value allows adjusting the mapping (in pixels) between the mouse's absolute vertical position on the Bizhawk window and that of the game.")]
