namespace BizHawk.Emulation.Cores.Computers.Commodore64.MOS
{
	public sealed partial class Vic
	{
		...
		private int ReadRegister(int addr)
		{
			return addr switch
			{
				0x00 or 0x02 or 0x04 or 0x06 or 0x08 or 0x0A or 0x0C or 0x0E => _sprites[addr >> 1].X & 0xFF,
				0x01 or 0x03 or 0x05 or 0x07 or 0x09 or 0x0B or 0x0D or 0x0F => _sprites[addr >> 1].Y & 0xFF,
				0x10 => ((_sprite0.X >> 8) & 0x01) |
											 ((_sprite1.X >> 7) & 0x02) |
											 ((_sprite2.X >> 6) & 0x04) |
											 ((_sprite3.X >> 5) & 0x08) |
											 ((_sprite4.X >> 4) & 0x10) |
				...
				0x11 => (_yScroll & 0x7) |
											 ...
											 ((_rasterLine & 0x100) >> 1),
				0x12 => _rasterLine & 0xFF,
				0x13 => _lightPenX & 0xFF,
				0x14 => _lightPenY & 0xFF,
				0x15 => (_sprite0.Enable ? 0x01 : 0x00) |
				...
				0x16 => 0xC0 | (_xScroll & 0x7) |
											  (_columnSelect ? 0x08 : 0x00) |
											  (_multicolorMode ? 0x10 : 0x00),
				0x17 => (_sprite0.YExpand ? 0x01 : 0x00) |
				...
				0x1C => (_sprite0.Multicolor ? 0x01 : 0x00) |
				...
				0x1D => (_sprite0.XExpand ? 0x01 : 0x00) |
				...
				0x1E => (_sprite0.CollideSprite ? 0x01 : 0x00) |
				...
				0x1F => (_sprite0.CollideData ? 0x01 : 0x00) |
				...
				0x20 => 0xF0 | _borderColor & 0x0F,
				0x21 => 0xF0 | _backgroundColor0 & 0x0F,
				0x22 => 0xF0 | _backgroundColor1 & 0x0F,
				0x23 => 0xF0 | _backgroundColor2 & 0x0F,
				0x24 => 0xF0 | _backgroundColor3 & 0x0F,
				0x25 => 0xF0 | _spriteMulticolor0 & 0x0F,
				0x26 => 0xF0 | _spriteMulticolor1 & 0x0F,
				0x27 or 0x28 or 0x29 or 0x2A or 0x2B or 0x2C or 0x2D or 0x2E => 0xF0 | _sprites[addr - 0x27].Color & 0xF,
				_ => 0xFF,
			};
		}
