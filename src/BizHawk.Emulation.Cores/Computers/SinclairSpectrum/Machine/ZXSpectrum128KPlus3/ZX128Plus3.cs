...
namespace BizHawk.Emulation.Cores.Computers.SinclairSpectrum
{
	...
	public partial class ZX128Plus3 : SpectrumBase
	{
		...
		/// Main constructor
		/// </summary>
		public ZX128Plus3(ZXSpectrum spectrum, Z80AOpt<ZXSpectrum.CpuLink> cpu, ZXSpectrum.BorderType borderType, List<byte[]> files, List<JoystickType> joysticks)
		{
			Spectrum = spectrum;
			CPU = cpu;
			...
			UPDDiskDevice = new Upd765DiskController();
