namespace BizHawk.MultiClient
{
	partial class SNESGraphicsDebugger
	{
		...
		private void InitializeComponent()
		{
			...
			this.grpQuadrants.SuspendLayout();
        ...
        "o fill specified size");
			...
			this.grpQuadrants.Controls.Add(this.rbQuad2);
			...
			this.grpQuadrants.TabStop = false;
			// 
			// rbQuad3
			// 
			this.rbQuad3.AutoSize = true;
			this.rbQuad3.Location = new System.Drawing.Point(26, 34);
			this.rbQuad3.Name = "rbQuad3";
			this.rbQuad3.Size = new System.Drawing.Size(14, 13);
			this.rbQuad3.TabIndex = 47;
			this.rbQuad3.UseVisualStyleBackColor = true;
			this.rbQuad3.CheckedChanged += new System.EventHandler(this.rbQuad_CheckedChanged);
			// 
			// rbQuad2
			// 
			this.rbQuad2.AutoSize = true;
			this.rbQuad2.Location = new System.Drawing.Point(4, 35);
			this.rbQuad2.Name = "rbQuad2";
			this.rbQuad2.Size = new System.Drawing.Size(14, 13);
			this.rbQuad2.TabIndex = 46;
			this.rbQuad2.UseVisualStyleBackColor = true;
			this.rbQuad2.CheckedChanged += new System.EventHandler(this.rbQuad_CheckedChanged);
			// 
			// rbQuadAll
			// 
			this.rbQuadAll.AutoSize = true;
			this.rbQuadAll.Location = new System.Drawing.Point(15, 22);
			this.rbQuadAll.Name = "rbQuadAll";
			this.rbQuadAll.Size = new System.Drawing.Size(14, 13);
			this.rbQuadAll.TabIndex = 45;
			this.rbQuadAll.UseVisualStyleBackColor = true;
			this.rbQuadAll.CheckedChanged += new System.EventHandler(this.rbQuad_CheckedChanged);
			// 
			// rbQuad1
			// 
			this.rbQuad1.AutoSize = true;
			this.rbQuad1.Location = new System.Drawing.Point(26, 10);
			this.rbQuad1.Name = "rbQuad1";
			this.rbQuad1.Size = new System.Drawing.Size(14, 13);
			this.rbQuad1.TabIndex = 44;
			this.rbQuad1.UseVisualStyleBackColor = true;
			this.rbQuad1.CheckedChanged += new System.EventHandler(this.rbQuad_CheckedChanged);
			// 
			// rbQuad0
			// 
			this.rbQuad0.AutoSize = true;
			this.rbQuad0.Checked = true;
			this.rbQuad0.Location = new System.Drawing.Point(5, 10);
			this.rbQuad0.Name = "rbQuad0";
			this.rbQuad0.Size = new System.Drawing.Size(14, 13);
			this.rbQuad0.TabIndex = 43;
			...
			this.grpQuadrants.ResumeLayout(false);
			this.grpQuadrants.PerformLayout();
		...
		private System.Windows.Forms.GroupBox grpQuadrants;
		private System.Windows.Forms.RadioButton rbQuad3;
		private System.Windows.Forms.RadioButton rbQuad2;
		private System.Windows.Forms.RadioButton rbQuadAll;
		private System.Windows.Forms.RadioButton rbQuad1;
		private System.Windows.Forms.RadioButton rbQuad0;
